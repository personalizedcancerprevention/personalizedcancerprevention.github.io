      ...
      <div className="layout" ref={targetRef}>
              ...
              <Button
                ...
                onClick={() =>
                  generatePDF(targetRef, {
                    filename: "MSK Prevent Report and Action Plan.pdf",
                  })
                }
              >
                <DownloadOutlined />
        ...
        <Row gutter={[16, 24]}>
          <Col className="gutter-row risk" span={20}>
            ...
            <div>
              ...
              It is caused by damage to the DNA in the skin cells, often caused
              by exposure to ultraviolet (UV) radiation from the sun or tanning
              beds.
            </div>

            <h3>Screening</h3>
            <div>
              We recommend you get screened for skin cancer with your own
              provider.
            </div>

            <h3>Already screened?</h3>
            <div>
              If you’ve already screened and your results indicate that you need
              treatment you can schedule an appointment with MSK for treatment.
            </div>
            ...
            <Button
              ...
              onClick={() => {
                window.open(
                  "https://www.mskcc.org/appointments/request-appointment?appointment_type=new",
                  "_blank"
                );
              }}
            >
            ...
            <div
              ...
              onClick={() => {
                window.open(
                  "https://www.mskcc.org/cancer-care/types/skin/screening-guidelines-skin",
                  "_blank"
                );
              }}
            >
            ...
            <div
              ...
              onClick={() => {
                window.open(
                  "https://www.mskcc.org/cancer-care/patient-education/preventing-skin-cancer",
                  "_blank"
                );
              }}
            >
        ...
        <Row gutter={[16, 24]}>
          <Col className="gutter-row risk" span={20}>
            <h2>Lung cancer</h2>
            <div>
              Lung cancer is a type of cancer that starts in the lungs, caused
              by uncontrolled growth of abnormal cells. Smoking is the leading
              cause of lung cancer, followed by exposure to secondhand smoke,
            ...
            <Button
              ...
              onClick={() => {
                window.open(
                  "https://appointments.mskcc.org/lung-screening",
                  "_blank"
                );
              }}
            >
            ...
            <div
              ...
              onClick={() => {
                window.open(
                  "https://www.mskcc.org/experience/patient-support/tobacco-treatment",
                  "_blank"
                );
              }}
            >
            ...
            <div
              ...
              onClick={() => {
                window.open(
                  "https://www.mskcc.org/cancer-care/types/lung/risk-factors-prevention",
                  "_blank"
                );
              }}
            >
        ...
        <Row gutter={[16, 24]}>
          <Col className="gutter-row risk" span={20}>
            ...
            <div>
              It is recommended that after 45 everyone at average risk for
              developing colorectal cancer should undergo regular screening for
              Colon Cancers.
            </div>

            <h3>Screening</h3>
            <div>
              We recommend you get screened for colon cancer with your own
              provider.
            </div>
            ...
            <div
              ...
              onClick={() => {
                window.open(
                  "https://www.mskcc.org/cancer-care/types/colon/guidelines",
                  "_blank"
                );
              }}
            >
            ...
            <div
              ...
              onClick={() => {
                window.open(
                  "https://www.mskcc.org/experience/become-patient/becoming-patient",
                  "_blank"
                );
              }}
            >
        ...
        <Row gutter={[16, 24]}>
          <Col className="gutter-row recommend" span={20}>
            Recommend MSK Prevent to others
            <Button
            ...
            <Modal
              title="Invite your friend to MSK Predict"
              open={isModalOpen}
              onOk={() => {
      ...
      <div className="layout" ref={targetRef}>
        ...
        <Row gutter={[16, 24]}>
          <Col className="gutter-row recommend" span={20}>
            ...
            <div>
              You can take steps to prevent cancer even if you are not at a
            ...
            <div
              ...
              onClick={() => {
                window.open(
                  "https://www.mskcc.org/cancer-care/patient-education/your-guide-preventing-gynecologic",
                  "_blank"
                );
              }}
            >
              What You Can Do To Prevent Gynecologic Cancer
            </div>
            <div
              className="resource"
              onClick={() => {
